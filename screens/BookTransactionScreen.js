...
export default class TransactionScreen extends React.Component {
  ...
  checkStudentEligibilityForBookReturn = async() => {
   const transactionRef = await db.collection("transcation").where("bookId", "==", this.state.scannedBookId).limit(1).get()
    var isStudentEligible = ""
  ...
  handleTransaction = async()=>{
    ...
    if(!transactionType){
      ...
      var isStudentAvailable = await this.checkStudentEligibilityForBookReturn()
